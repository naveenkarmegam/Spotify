...
const updateRecentlyPlayedMenu = () => {
  ...
  document
    .querySelectorAll(".recently-played .playListPlay")
    .forEach((playButton) => {
...
//recently play end funality end here
...
songs.forEach((element) => {
  ...
  card.addEventListener("click", (event) => {
    ...
    const clickedValue =
      event.currentTarget.querySelector(".content").textContent;
